  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col justify-center items-center px-6 py-12 relative z-10">
        {/* Subtle background orb behind the form */}
        <div
        ...
        >
          ...
          <div className="flex items-center gap-2.5 mb-8">
            ...
            <span
              className="font-display font-bold text-xl tracking-[-0.02em]"
          ...
          <div className="mb-7">
            <AnimatePresence mode="wait">
              ...
              >
                <h1
                  className="font-display font-bold text-2xl tracking-[-0.03em] mb-1"
                  style={{ color: 'var(--text-primary)' }}
                >
      ...
      >
        ...
        >
          ...
          {/* Headline */}
          <h2
            className="font-display font-extrabold text-3xl tracking-[-0.04em] mb-4 leading-tight"
            style={{ color: 'var(--text-primary)' }}
          >
          ...
          <div className="grid grid-cols-3 gap-3 mb-10">
            {STATS.map((s, i) => (
              ...
              >
                <p
                  className="font-display font-extrabold text-2xl tracking-[-0.03em]"
                  style={{ color: 'var(--accent)' }}
                >
                  {s.value}
                </p>
...
/* ─────────────────────────────────────────────
   PAGE EXPORT — Suspense boundary for
   useSearchParams()
───────────────────────────────────────────── */
